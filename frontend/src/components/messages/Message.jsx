...
const Message = ({message}) => {
  ...
  const bubbleBgColor = fromMe ? 'bg-primary' : "bg-neutral"
  ...
  return (
    <div className={`chat ${chatClassName}`}>
        ...
        <div className={`chat-footer opacity-50 text-xs flex gap-4 items-center mt-1`}>
          {formattedTime}
        </div>
    </div>
  )
...
//               </div>
//           </div>
//           <div className={`chat-bubble text-white bg-primary`}>Hi! What's upp?</div>
